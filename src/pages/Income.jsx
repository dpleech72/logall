export default function Income() {
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold text-gray-900 pt-2 mb-1">Income</h1>
      <p className="text-gray-500 text-sm mb-6">Payments received</p>
      <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm flex flex-col items-center justify-center text-center gap-3">
        ...
        <p className="text-gray-400 text-sm">Tap the button to log your first payment</p>
