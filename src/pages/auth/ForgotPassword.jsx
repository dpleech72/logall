  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center px-6 py-12">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 max-w-sm mx-auto w-full">
        <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Forgot your password?</h2>
        <p className="text-gray-500 dark:text-gray-400 dark:text-gray-500 text-sm mb-6">No problem. Enter your email and we'll send you a reset link.</p>
